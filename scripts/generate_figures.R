...
tiff("figures/Fig1.tiff", units="in", width=4, height=1.6, res=400)
...
tiff("figures/Fig2.tiff", units="in", width=4, height=3.5, res=400)
data %>%
...
tiff("figures/Fig3.tiff", units="in", width=14, height=5, res=400)
p1 <- data %>%
